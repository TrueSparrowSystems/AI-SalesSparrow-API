...
public class LocalCipher {
	...
	public String encrypt(String salt, String string) {
		...
		try {
			...
			throw new CustomException(new ErrorObject("l_lc_e_1", "something_went_wrong", e.getMessage()));
		}
	...
	public String decrypt(String salt, String encryptedString) {
		...
		try {
			...
			throw new CustomException(new ErrorObject("l_lc_d_1", "something_went_wrong", e.getMessage()));
		}
