 ...
 * but it won't be as efficient as doing it in a filter. That's because, by the time the interceptor 
 * is called, some part of the request processing within the Spring MVC framework has already happened.
 *
 */
public class SameSiteCookieFilter implements Filter {
     ...
     * Override the doFilter method to wrap the response object with a custom wrapper.
     * 
     * @param request
     * @param response
     * @param chain
    ...
    */
    ...
    /**
     * Custom wrapper to intercept the setHeader calls and add SameSite attribute to the cookie.
     * Set SameSite=lax
     * lax will ensure that cookies are sent only if the request originates from the same site.
     * It will also send the cookie if the user is navigating from an external site, 
     * but only if the URL in the browser’s address bar matches the URL of the current site.
    */
