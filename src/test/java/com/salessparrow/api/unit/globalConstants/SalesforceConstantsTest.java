...
public class SalesforceConstantsTest {
	...
	void testSalesforceCompositeUrl() {
		assertEquals("https://test.salesforce.com/services/data/v58.0/composite",
				new SalesforceConstants().salesforceCompositeUrl("https://test.salesforce.com"));
	}

	@Test
	void testOauth2AuthorizeUrl() {
		assertEquals("https://test.salesforce.com/services/oauth2/authorize",
				new SalesforceConstants().oauth2AuthorizeUrl());
	}
	...
	void testSalesforceAttachNoteUrl() {
		assertEquals("/services/data/v58.0/sobjects/ContentDocumentLink",
				new SalesforceConstants().salesforceAttachNoteUrl());
	}
	...
	void testSalesforceNotesContentUrl() {
		assertEquals("https://test.salesforce.com/services/data/v58.0/sobjects/ContentNote/123/Content",
				new SalesforceConstants().salesforceNotesContentUrl("https://test.salesforce.com", "123"));
	}
