...
public class DescribeAccountTest {
	...
	public void describeAccount(Scenario testScenario) throws Exception {

		// Load fixture data
		String currentFunctionName = new Object() {
		}.getClass().getEnclosingMethod().getName();
		FixtureData fixtureData = common.loadFixture(
				"classpath:fixtures/functional/controllers/accountController/describeAccount.fixtures.json",
				currentFunctionName);
		...
		String url = "/api/v1/accounts/describe";
	...
	private static List<Scenario> loadScenarios() throws IOException {
		String scenariosPath = "classpath:data/functional/controllers/accountController/describeAccount.scenarios.json";
