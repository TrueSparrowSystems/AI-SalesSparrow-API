...
public class UpdateAccountTest {
	...
	public void updateAccount(Scenario testScenario) throws Exception {

		// Load fixture data
		String currentFunctionName = new Object() {
		}.getClass().getEnclosingMethod().getName();
		FixtureData fixtureData = common.loadFixture(
				"classpath:fixtures/functional/controllers/accountController/updateAccount.fixtures.json",
				currentFunctionName);
	...
	private static List<Scenario> loadScenarios() throws IOException {
		String scenariosPath = "classpath:data/functional/controllers/accountController/updateAccount.scenarios.json";
