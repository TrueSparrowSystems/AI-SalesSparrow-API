...
public class UpdateAccountNoteTest {
	...
	public void updateAccountNote(Scenario testScenario) throws Exception {

		// Load fixture data
		String currentFunctionName = new Object() {
		}.getClass().getEnclosingMethod().getName();
		FixtureData fixtureData = common.loadFixture(
				"classpath:fixtures/functional/controllers/accountNoteController/updateAccountNote.fixtures.json",
				currentFunctionName);
	...
	private static List<Scenario> loadScenarios() throws IOException {
		String scenariosPath = "classpath:data/functional/controllers/accountNoteController/updateAccountNote.scenarios.json";
